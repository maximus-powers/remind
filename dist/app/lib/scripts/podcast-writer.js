...
export async function generateScript() {
    ...
    const themeResponse = await generateObject({
        ...
        schema: z.object({
            ...
            section1: z
                .array(z.number())
                .describe(`5-10 card ids from tab ${cardsByTab[0].tabId} that fit the theme`),
            section2: z
                .array(z.number())
                .describe(`5-10 card ids from tab ${cardsByTab[1].tabId} that fit the theme`),
            section3: z
                .array(z.number())
                .describe(`5-10 card ids from tab ${cardsByTab[2].tabId} that fit the theme.`),
        }),
    ...
    const scriptResponse = await generateObject({
        ...
        schema: z.object({
            ...
            section1: z
                .array(z.string())
                .describe(`A short summary of the concept of each card from tab ${cardsByTab[0].tabId}`),
            section2: z
                .array(z.string())
                .describe(`A short summary of the concept of each card from tab ${cardsByTab[1].tabId}`),
            section3: z
                .array(z.string())
                .describe(`A short summary of the concept of each card from tab ${cardsByTab[2].tabId}`),
