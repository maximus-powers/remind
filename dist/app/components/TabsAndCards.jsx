...
const TabsAndCards = () => {
  ...
  useEffect(() => {
    const fetchTabsAndCards = async () => {
      ...
      const reversedTabsWithCards = tabsWithCards.map((tab) =>
        Object.assign(Object.assign({}, tab), { cards: tab.cards.reverse() })
      );
    ...
    <div className="p-5 bg-gray-800 text-white">
      <div className="flex items-center">
        ...
        <Button
          ...
          variant="contained"
          color="primary"
          className="mb-5 whitespace-nowrap w-8"
        >
          <Add />
        </Button>
      </div>
      {tabs.map((tab, tabIndex) => {
        ...
        return (
          <div
            ...
            className="bg-slate-500 p-5 rounded-b-lg"
          >
            <Button
              ...
              className="mr-2 mb-5 w-full"
            >
              <Add /> Add Card
            </Button>
            <div className="flex flex-wrap gap-2">
              {(_a = tab.cards) === null || _a === void 0
                ? void 0
                : _a.map((card, cardIndex) => (
                    <Card key={cardIndex} className="w-full mb-2">
                      <CardContent className="flex flex-col md:flex-row">
                        <input
                          value={card.title}
                          onKeyDown={(e) =>
                            handleCardKeyDown(e, tabIndex, cardIndex)
                          }
                          onBlur={() =>
                            updateCardContentHandler(tabIndex, cardIndex)
                          }
                          onChange={(e) =>
                            handleInputChange(e, tabIndex, cardIndex, 'title')
                          }
                          placeholder="Title"
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            handleInputChange(e, tabIndex, cardIndex, 'text')
                          }
                          placeholder="Text"
                        ...
                        <IconButton
                          onClick={() =>
                            deleteExistingCardHandler(tabIndex, cardIndex)
                          }
