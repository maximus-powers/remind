...
const Page = () => {
    ...
    const storeUserEmail = async (session) => {
        var _a;
    ...
    return (<div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        {isSignedIn ? (<Button variant="outline" onClick={() => signOut()}>
            Sign out
          </Button>) : (<Button variant="outline" onClick={() => signIn('google')}>
            Sign in
          </Button>)}
      </div>
      ...
      {isSignedIn ? (<>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-5">
              Create personal podcasts to remind you of facts you&apos;ve added
              to your knowledge base.
            </p>
            <Button size="lg" className="mt-6 mx-auto bg-white text-gray-500 border border-gray-300 hover:bg-gray-50 flex items-center justify-center" onClick={() => signIn('google')}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-12">
              <div className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
                ...
                <p className="text-muted-foreground">
                  Create tabs and cards to organize your favorite facts.
                </p>
              </div>
              <div className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
                <div className="h-12 w-12 mb-4 rounded-full bg-primary/20 flex items-center justify-center">
                ...
                <p className="text-muted-foreground">
                  Facts are curated based on which were least-recently included
                  in a podcast, and which fit a podcast&apos;s theme.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-5">
              Here&apos;s what your dashboard will look like after you sign in
              and add a few facts.
            </p>
          </div>
          <div className="space-y-5 mt-20">
            ...
            <div className="p-1">
              <div className="flex flex-wrap gap-2 mb-4 justify-center">
                {['Quotes', 'Psychology', 'History'].map((tabName, index) => (<div key={index} className={`bg-${index === 0 ? 'red' : index === 1 ? 'blue' : 'green'}-500 text-white py-2 px-5 rounded-lg ${index === 0 ? 'font-bold shadow-lg' : 'opacity-70'}`}>
                    {tabName}
                  </div>))}
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card>
                  <CardContent className="pt-4">
                    ...
                    <p className="text-muted-foreground">
                      &quot;I don&apos;t exactly know what I mean by that, but I
                      mean it.&quot;
                    </p>
                  </CardContent>
                </Card>
